...
class LoginLocation {
  ...
  LoginLocation({required this.ipAddress, required this.address});

  factory LoginLocation.fromJson(Map<String, dynamic> json) =>
      LoginLocation(ipAddress: json["ipAddress"], address: json["address"]);

  Map<String, dynamic> toJson() => {"ipAddress": ipAddress, "address": address};
}
