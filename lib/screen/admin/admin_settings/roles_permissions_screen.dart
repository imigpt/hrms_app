...
class _AdminRolesPermissionsScreenState
  ...
  Future<void> _loadModules() async {
    try {
      final res =
          await SettingsService.getPermissionModules(widget.token ?? '');
  ...
  Future<void> _savePermissions() async {
    ...
    try {
      await SettingsService.assignPermissions(
          widget.token ?? '', _selectedRole!['_id'], list);
      if (mounted)
        showAdminSnack(context, 'Permissions saved for ${_selectedRole!['name']}');
    } catch (_) {
      if (mounted)
    ...
    showDialog(
      ...
      builder: (_) => StatefulBuilder(
        builder: (ctx, setDlg) => AlertDialog(
          ...
          title: Text(editing == null ? 'Create Role' : 'Edit Role',
              style: const TextStyle(
                  color: Colors.white, fontWeight: FontWeight.w700)),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              _DlgField(label: 'Role Name', ctrl: nameCtrl, hint: 'e.g. Manager'),
              ...
              onTap: saving
                  ...
                  : () async {
                      ...
                      try {
                        ...
                        if (mounted)
                          showAdminSnack(context, 'Operation failed',
                              error: true);
                      } finally {
      ...
      builder: (_) => StatefulBuilder(
        builder: (ctx, setDlg) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              Text('Type "${role['name']}" to confirm deletion.',
                  style:
              ...
              onTap: deleting
                  ...
                  : () async {
                      ...
                      try {
                        ...
                        await _loadRoles();
                        if (mounted)
                          showAdminSnack(context, 'Role deleted');
                        ...
                        if (mounted)
                          showAdminSnack(context, 'Delete failed',
                              error: true);
                      } finally {
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text('Select a role to manage its permissions',
                style: TextStyle(color: Colors.grey[600], fontSize: 13),
            ...
            itemBuilder: (_, i) {
              ...
              return Container(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: Text(module['name']?.toString() ?? mid,
                          style: const TextStyle(
                              color: Colors.white,
                              fontSize: 12,
        ...
        Padding(
          ...
          child: SizedBox(
            ...
            child: AdminSaveButton(
                saving: false, onTap: _savePermissions),
          ),
        ),
      ],
    );
