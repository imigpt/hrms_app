  ...
  factory AttendanceRecord.fromJson(Map<String, dynamic> json) =>
      AttendanceRecord(
        ...
        checkIn: json["checkIn"] != null
            ? RecordCheckIn.fromJson(json["checkIn"])
            : RecordCheckIn.fromJson({}),
...
class RecordCheckIn {
  ...
  RecordCheckIn({required this.time, this.location, required this.photo});

  factory RecordCheckIn.fromJson(Map<String, dynamic> json) => RecordCheckIn(
    time: json["time"] != null
    ...
    photo: json["photo"] != null
        ? RecordPhoto.fromJson(json["photo"])
        : RecordPhoto.fromJson({}),
  );
...
class RecordCheckOut {
  ...
  RecordCheckOut({required this.time, this.location});

  factory RecordCheckOut.fromJson(Map<String, dynamic> json) => RecordCheckOut(
    time: json["time"] != null
        ? DateTime.parse(json["time"]).toLocal()
        : DateTime.now(),
    location: json["location"] != null
...
class RecordLocation {
  ...
  RecordLocation({required this.latitude, required this.longitude});
...
class RecordPhoto {
  ...
  RecordPhoto({required this.url, required this.publicId, this.capturedAt});
